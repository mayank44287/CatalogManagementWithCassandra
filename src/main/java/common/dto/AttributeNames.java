...
/**
 * this enum contains attributes names for listing, product
 * the value of enum is same as col name in listing CF and product CF
 *
 * we use this enum value when we want to mention the column names in statements
 */
...
public enum AttributeNames {
    ...
    AttributeNames(String value){this.value = value;}
